	...
	class Table {
									...
									<?php if ( $column['is_primary'] ): ?>
                                        <button type="button" class="toggle-row">
                                            <span class="screen-reader-text">
                                                <?php _e( 'Show more details', 'arraypress' ); ?>
                                            </span>
                                        </button>
									<?php endif; ?>
                                </td>
		...
		private function render_cell( array $column, string $column_key, $row, array $table ): string {
			...
			if ( empty( $value ) ) {
				...
				$value = Table . phpwp_kses_post( $prefix ) . wp_kses_post( $value ) . wp_kses_post( $suffix );
			}
		...
		private function render_pagination( array $pagination ): void {
			...
			$output = '<span class="displaying-num">' . sprintf(
					_n( '%s item', '%s items', $pagination['total_items'], 'arraypress' ),
