...
/**
 * Check if the class `Field` is defined, and if not, define it.
 */
if ( ! class_exists( 'Field' ) ):
	/**
	 * Field Class
	 *
	 * Provides a comprehensive set of methods for generating HTML form elements and structures
	 * in WordPress. This class focuses on creating standardized, accessible, and secure form
	 * components while maintaining consistency with WordPress coding standards.
	 */
	class Field {
		 ...
		 */
		private static function wrap_field( string $field, array $args, bool $label_after = false ): string {
		...
		private static function create_input(
			...
			return self::wrap_field( $field, $args, $label_after );
		}
		...
		public static function wp_media_upload( array $args = [] ): string {
			...
			return self::wrap_field( $field, $args );
		}
