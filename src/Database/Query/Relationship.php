...
/**
 * Check if the class `Relationship` is defined, and if not, define it.
 */
if ( ! class_exists( 'Relationship' ) ) :

	/**
	 * Relationship Query Helper Class
	 *
	 * This class provides methods to construct queries for post relationships in WordPress.
	 * It supports both simple and complex relationship queries.
	 */
	class Relationship {
