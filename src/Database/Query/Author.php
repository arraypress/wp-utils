...
/**
 * Check if the class `Author` is defined, and if not, define it.
 */
if ( ! class_exists( 'Author' ) ) :

	/**
	 * Author Query Helper Class
	 *
	 * This class provides a set of methods to easily construct author queries for WordPress.
