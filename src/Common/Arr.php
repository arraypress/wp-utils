...
/**
 * Check if the class `Arr` is defined, and if not, define it.
 */
if ( ! class_exists( 'Arr' ) ) :
	 ...
	 * Array Helper Utilities
	 *
	 * Provides utility functions for working with arrays, such as sorting, shuffling,
	 * filtering, key management, and recursive operations. It also includes functionality
	 * for converting arrays to JSON, XML, and delimited strings. Additional features include
	 * methods for flattening arrays, normalizing values, and random selections.
	 */
	class Arr {
