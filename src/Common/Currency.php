...
class Currency {
	 ...
	 * @param bool  $is_inclusive Whether the tax is inclusive (true) or exclusive (false). Default is false
	 *                            (exclusive).
	 ...
	 * @param bool  $is_inclusive  Whether the discount is inclusive (true) or exclusive (false). Default is false
	 *                             (exclusive).
	 * @param int   $precision     The number of decimal places to round to. Default is 2.
	 *
