 ...
 * Class Blocks
 *
 * Utility functions for working with multiple blocks.
 */
class Blocks {
	 ...
	 * @return array
	 */
	public static function search_by_type( array $blocks, string $type ): array {
		$found = [];
		...
		if ( ! empty( $blocks ) ) {
			foreach ( $blocks as $block ) {
				...
				if ( ! empty( $block['innerBlocks'] ) ) {
					$found = array_merge( $found, self::search_by_type( $block['innerBlocks'], $type ) );
				}
			}
		}
