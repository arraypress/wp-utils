...
/**
 * Check if the class `Block` is defined, and if not, define it.
 */
if ( ! class_exists( 'Block' ) ) :

	/**
	 * Block utility class for WordPress.
	 *
	 * This class provides utility methods for working with individual blocks in WordPress,
	 * including attribute manipulation, content extraction, and block transformation.
	 */
	class Block {
