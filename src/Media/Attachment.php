...
class Attachment {
	...
	public static function exists( int $attachment_id ): bool {
		return self::get( $attachment_id ) !== null;
	}

	/**
	 * Get an attachment post object.
	 *
	 * @param int $attachment_id The attachment ID.
	 *
	 * @return WP_Post|null The attachment post object if found, null otherwise.
	 */
	public static function get( int $attachment_id ): ?\WP_Post {
