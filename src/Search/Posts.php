...
namespace ArrayPress\Utils\Search;
...
if ( ! class_exists( 'Posts' ) ) :
	 ...
	 * Posts Search
	 *
	 * Provides an interface to search for posts with advanced filtering options.
	 */
	class Posts {
		 ...
		 * @param string       $field    Select taxonomy term by. Possible values are 'term_id', 'name', 'slug' or 'term_taxonomy_id'.
		 * @param string       $operator Operator to test. Possible values are 'IN', 'NOT IN', 'AND', 'EXISTS' and 'NOT EXISTS'.
		 *
		 * @return self
		 */
		 ...
		 * @param string $compare The comparison operator (=, !=, >, >=, <, <=, LIKE, NOT LIKE, IN, NOT IN, BETWEEN, NOT BETWEEN, EXISTS, NOT EXISTS).
		 ...
		 * @param array  $args           Optional. Additional arguments to pass to the search query. Default is an empty array.
